...
const CARDS = [
  ...
  { idx: 1, name: 'Nar Bir Subbha',  age: 58, from: '10.5', to: '6.8', fx: '86%', fy: '22%', sr: '12deg',  stx: '26px',  sty: '12px',  mfx: '80%', mfy: '5%',  msr: '9deg',   mstx: '16px',  msty: '10px',  img: 'https://kinsdiabetes.com/images/Nar%20Bir%20Subha%20PT.jpg' },
