...
const CARDS = [
  { idx: 0, name: 'Subhash M',  age: 54, from: '9.2',  to: '6.4', fx: '14%', fy: '22%', sr: '-14deg', stx: '-28px', sty: '18px',  img: 'https://images.unsplash.com/photo-1582750433449-648ed127bb54?w=500&h=500&fit=crop' },
  { idx: 1, name: 'Pradeep K',  age: 58, from: '10.5', to: '6.8', fx: '86%', fy: '22%', sr: '12deg',  stx: '26px',  sty: '12px',  img: 'https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=500&h=500&fit=crop' },
  { idx: 2, name: 'Mira D',     age: 62, from: '8.9',  to: '5.9', fx: '8%',  fy: '52%', sr: '-8deg',  stx: '-20px', sty: '-14px', img: 'https://images.unsplash.com/photo-1594824476967-48c8b964273f?w=500&h=500&fit=crop' },
  { idx: 3, name: 'Raymond J',  age: 48, from: '8.2',  to: '7.0', fx: '90%', fy: '52%', sr: '18deg',  stx: '22px',  sty: '-10px', img: 'https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=500&h=500&fit=crop' },
  { idx: 4, name: 'Kanchana B', age: 48, from: '8.5',  to: '6.7', fx: '16%', fy: '80%', sr: '-6deg',  stx: '-16px', sty: '20px',  img: 'https://images.unsplash.com/photo-1651008376811-b90baee60c1f?w=500&h=500&fit=crop' },
  { idx: 5, name: 'Rajni B',    age: 61, from: '11.3', to: '5.9', fx: '82%', fy: '80%', sr: '9deg',   stx: '18px',  sty: '16px',  img: 'https://images.unsplash.com/photo-1607746882042-944635dfe10e?w=500&h=500&fit=crop' },
];
  ...
  return (
    <>
      ...
      <section ref={sectionRef} style={S.section}>
        <div className='h-screen py-20' style={S.pin}>
