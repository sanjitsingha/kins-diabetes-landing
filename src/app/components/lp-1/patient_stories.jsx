...
const CARDS = [
  { idx: 0, name: 'Subhash Ghosh',  age: 54, from: '8.2',  to: '6.5', fx: '14%', fy: '22%', sr: '-14deg', stx: '-28px', sty: '18px',  mfx: '14%', mfy: '9%',  msr: '-11deg', mstx: '-18px', msty: '14px',  img: 'https://kinsdiabetes.com/images/Subash%20Ghosh%20PT.jpg' },
  { idx: 1, name: 'Nar Bir Subbha',  age: 58, from: '6.3', to: '5.8', fx: '86%', fy: '22%', sr: '12deg',  stx: '26px',  sty: '12px',  mfx: '80%', mfy: '5%',  msr: '9deg',   mstx: '16px',  msty: '10px',  img: 'https://kinsdiabetes.com/images/Nar%20Bir%20Subha%20PT.jpg' },
  { idx: 2, name: 'Padma Lohagan',     age: 62, from: '8.9',  to: '5.9', fx: '8%',  fy: '52%', sr: '-8deg',  stx: '-20px', sty: '-14px', mfx: '46%', mfy: '16%', msr: '-6deg',  mstx: '-12px', msty: '-10px', img: 'https://kinsdiabetes.com/images/Padma%20Lohagan.jpg' },
  { idx: 3, name: 'Bimal Rai',  age: 48, from: '8.2',  to: '6', fx: '90%', fy: '52%', sr: '18deg',  stx: '22px',  sty: '-10px', mfx: '64%', mfy: '82%', msr: '14deg',  mstx: '14px',  msty: '-8px',  img: 'https://kinsdiabetes.com/images/Bimal%20Rai.jpg' },
  { idx: 4, name: 'Khusang Tamang', age: 48, from: '8.5',  to: '6.7', fx: '16%', fy: '80%', sr: '-6deg',  stx: '-16px', sty: '20px',  mfx: '20%', mfy: '88%', msr: '-9deg',  mstx: '-12px', msty: '16px',  img: 'https://www.kinsdiabetes.com/images/Khusang%20Dolma.jpg' },
  { idx: 5, name: 'Ajay Kumar Sinha',    age: 61, from: '8.3', to: '5.8', fx: '82%', fy: '80%', sr: '9deg',   stx: '18px',  sty: '16px',  mfx: '82%', mfy: '96%', msr: '7deg',   mstx: '12px',  msty: '12px',  img: 'https://kinsdiabetes.com/images/Ajay%20Kumar%20Singha.jpg' },
];
