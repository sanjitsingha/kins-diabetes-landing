          ...
          <table className="min-w-full border border-gray-200 text-sm text-gray-700">
            <thead className="bg-gray-100 text-gray-900">
              <tr>
                ...
                <th className="px-4 py-3 text-left  border-b">Others Offer</th>
              </tr>
            </thead>
            <tbody>
              <tr className="border-b-3 border-white text-[#12a4dd]   bg-[#12a4dd]/4 ">
              ...
              <tr className="border-b-3 border-white  bg-[#12a4dd]/4">
                <td className="px-4 text-[#12a4dd]   border-r-3 border-white py-3">
                  Digital Diabetes Care Program
                </td>
                <td className="px-4 border-r-3 border-white  py-3 text-green-600 ">
                  <CheckCircle2 size={22} color="#12a4dd" />
                </td>
                <td className="px-4  border-r-3 border-white py-3 text-red-500 ">
                  <XCircle size={22} />
                </td>
              </tr>
              <tr className="border-b-3 border-white  bg-[#12a4dd]/4 ">
                <td className="px-4 border-r-3 text-[#12a4dd]  border-white py-3">
                  Personalized Counseling
                </td>
                <td className="px-4 border-r-3 border-white py-3 text-green-600 ">
                  <CheckCircle2 size={22} color="#12a4dd" />
                </td>
                <td className="px-4 border-r-3 border-white py-3 text-yellow-500 ">
                  <Info size={22} />
                </td>
              </tr>
              <tr className="border-b-3 border-white  bg-[#12a4dd]/4 ">
